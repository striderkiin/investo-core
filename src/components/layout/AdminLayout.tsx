...
const ALL_NAV_ITEMS: (SidebarNavItem & { permission?: Permission })[] = [
  ...
  { to: '/admin/kyc', label: 'Identity Verification', icon: 'bi-person-check', permission: 'compliance.manage' },
  ...
  { to: '/admin/contact-messages', label: 'Contact Messages', icon: 'bi-envelope-paper', permission: 'support.read' },
